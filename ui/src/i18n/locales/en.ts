...
export const en: TranslationMap & {
  ...
  modelSetup: {
    ...
    wizard: {
      ...
      deviceCodeSafety: "Only continue if you started this sign-in.",
      copy: "Copy",
  ...
  modelProviders: {
    ...
    globalUsage: "Usage and cost · all agents",
    localCost: "Session spend · last {days} days",
    localCostDetail: "{tokens} tokens · {sessions} sessions",
    costUnavailable: "Cost unavailable",
    costIncomplete: "Some sessions have no pricing data; this total is incomplete.",
    saving: "Saving…",
    requestFailed: "Request failed.",
    configUnavailable: "Configuration is unavailable. Refresh and try again.",
    credentials: {
      ...
      oauthOne: "1 OAuth account",
      oauthMany: "{count} OAuth accounts",
      tokenOne: "1 access token",
      tokenMany: "{count} access tokens",
      configKey: "API key set in config",
      envKey: "API key from environment",
      envKeyNamed: "API key from environment ({name})",
      profileKeyOne: "1 saved API key",
      profileKeyMany: "{count} saved API keys",
    },
    apiKey: {
      label: "API key",
